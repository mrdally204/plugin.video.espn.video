...
def build_sub_directory(url, thumb):
	...
	html = html.decode('UTF-8','ignore') #Swedemon fix 2015-02-16
...
def build_video_directory(url, name, type):
	...
	if name == settings.getLocalizedString( 30005 ):
		...
		html = html.decode('UTF-8','ignore') #Swedemon fix 2015-03-27
		...
		html = html.decode('UTF-8','ignore') #mrdally204 FireTv Change 2015-08-19
